# target city bot
BotFramework and Adobe Target Integration
...
In order for the bot to integrate with Adobe Target, follow the steps below:
- The following details need to be provided in the environment file (.env)
    - **TARGET_CLIENTCODE:** The Target account client code (Can be found in the admin console)
    - **ORG_ID:** Organization ID
    - **TARGET_PROPERTY:** Target Property (Optional - When using multiple properties in Target)
    - **MBOX:**  Mbox name - Will be used as the activity location inside Target.
    - **SUCCESS_MBOX:**  Mbox name - Will be used as the activity location inside Target.
    - **LOGGER:** Set to true to enable Target logging
